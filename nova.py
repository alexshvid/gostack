...
if openstack_conf.version == 'grizzly':
  if openstack_conf.useQuantum:
    ...
    props['public_interface'] = (None, openstack_conf.floating_int)
    #props['vlan_interface'] = (None, openstack_conf.floating_int)
    ...
    props['flat_network_dhcp_start'] = (None, openstack_conf.fixed_dhcpstart)
